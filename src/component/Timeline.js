...
function Timeline() {
  const timeline = [
    ...
    },
    {
      ...
      Ques:"Q2 2022",
      description:"After the first phase, our world-class team will commence the development of BOM’s website, Application, and Plugins, which companies can utilize to directly integrate BOM into their online platforms (compatible with most types of sites)."
    },
    {
      counter:"03",
    ...
    },
    {
      ...
      Ques:"Q3 2022",
      description:"To get the attention and vital support of early adopters, the very first BOM Airdrops will take place, seasoned with engaging contests and giveaways to establish a rock-solid follower base."
    },
    {
      counter:"05",
      title:"ICO & Public Token Sale",
      Ques:"Q4 2022",
      description:"Right before the grand launch, we will hold our Initial Coin Offering (ICO) as well as the first publicly available pre-sales. This will be a great time for our initial investors to partially cash in on their early positions."
    },
    {
      counter:"06",
      title:"Full-blown launch",
      Ques:"Q4 2022",
      description:"Finally, after years of careful planning and design, BOM’s platforms will become reality and launch with all their revolutionary capabilities fully functioning. "
    }
  ]
  return (
    <>
